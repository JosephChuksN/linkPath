...
import { faUpload, faTrashCan, faXmarkCircle } from '@fortawesome/free-solid-svg-icons'

const AddLinkImg = ({handleInputFileClick, showAddImg, setShowAddImg}) => {


  return (
    <div className={`${!showAddImg? "hidden" : ""} flex items-center flex-col gap-1 py-2 px-3 w-64 absolute bg-white border top-10 left-0 z-20 md:-left-40 rounded-md`}>
    <span 
