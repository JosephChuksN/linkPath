  ...
  return (
    <div className='grid grid-cols-1 lg:grid-cols-2 mx-2 gap-3'>
        ...
        <div className='flex md:flex-row-reverse  flex-col-reverse w-2/3  lg:px-0 px-5 items-center mx-auto gap-9 mt-3 '>
            ...
            <span className='absolute w-5 h-5 rounded-full bg-white lg:left-[27rem] lg:top-20 md:right-56 bottom-[18.5rem] right-[5.5rem] flex items-center justify-center border border-black/40'> <FontAwesomeIcon className=' text-sm' icon={faLock} /></span>
