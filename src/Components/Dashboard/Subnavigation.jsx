...
const navData = [
    ...
    {id:2, name:'Socials', icon:faShareNodes, link:'social'},
  ...
  return (
   <>
    <div className= ' mb-3 flex justify-center items-center bg-white z-20  py-5 '>
        <ul className='flex px-10 gap-10 text-[1rem] font-normal justify-left w-full lg:w-3/5 '>{
        navData.map((data)=>(
           ...
           <span className={`flex items-center justify-center text-gray-400 rounded-full w-12 h-12 bg-slate-300/30  `}><FontAwesomeIcon  icon={data.icon} /></span>
