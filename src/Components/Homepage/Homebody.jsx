...
<div className='pt-20 md:py-20 lg:w-1/2 px-1 flex flex-col gap-5'>
   ...
   <Link to={user? "dashboard" : "signup"}><span className='bg-cyan-600 px-3 py-2 rounded-md text-white'>Get Started</span></Link>
     <div className='p-1'>   <span>Already have an account?</span> <Link to="login"><span className='text-cyan-600'>Log in</span></Link></div>
    </div>
</div>
    </div>
  )
