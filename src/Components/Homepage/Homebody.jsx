...
<div className='pt-20 md:py-20 lg:w-1/2 px-1 flex flex-col gap-5'>
    ...
    <span className='font-normal text-2xl'>Embed the links to your socails, website, events, store music and more in one page.</span>
    <div className='py-3  space-y-2'>
   <Link to={user? "/dashboard" : "/signup"}><span className='bg-blue-600 px-3 py-2 rounded-md text-white'>Get Started</span></Link>
