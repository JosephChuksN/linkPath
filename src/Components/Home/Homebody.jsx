...
<div className='lg:w-1/2 w-full h-3/5 flex max-h-[80%] mx-auto '>
  ...
  />
<span className='absolute -top-40 lg:top-0 right-0 z-[-1]  '><img src={Home2} alt="deco" /></span>
<span className='absolute top-64 z-[-1] lg:top-44 left-0'><img  src={Home1} alt="deco" /></span>
</div>
</div>
  )
}
