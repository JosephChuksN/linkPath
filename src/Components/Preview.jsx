...
<div className='flex flex-col w-full px-10 h-full  items-center overflow-y-auto'>
       ...
       <Link to="/dashboard/link" className='absolute bottom-10 left-48 w-12 h-12 flex items-center justify-center rounded-full bg-cyan-600'><span className='min-w-full text-2xl text-white p-2  rounded-full text-center '><FontAwesomeIcon icon={faClose} /></span></Link>
    </div>
  )
}
