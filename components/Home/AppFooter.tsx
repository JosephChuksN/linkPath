...
const AppFooter:FC = () => {
  ...
  return (
    <div
      id="contact"
      className="flex flex-col font-poppins pt-10 pb-5 px-3 lg:px-20 gap-5 bg-[#D9D9D9]"
    >
      <div className="flex flex-col lg:grid lg:grid-cols-3 gap-5 justify-between grid-flow-row py-3 border-b-[1px] border-black">
        <div className="flex flex-col gap-2 ">
          <span className="text-cyan-600 font-semibold text-xl lg:text-2xl">
            LINKPATH
          </span>
          <span className="lg:w-4/5 text-md lg:text-xl">
        ...
        <div className="flex flex-col gap-2 ">
          ...
          <span className="flex items-center gap-3">
            <input
              className="p-1 rounded-lg lg:w-3/5"
              type="email"
              name=""
              placeholder="Email"
            />
            <button className="py-1 px-3 rounded-lg text-white bg-cyan-600 shadow-md shadow-cyan-600 transition-all delay-75 duration-300 ease-in-out hover:bg-cyan-700 hover:scale-105">
              Subcribe
            </button>
          </span>
        </div>
